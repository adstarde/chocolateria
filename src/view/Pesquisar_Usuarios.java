 ...
 */
public class Pesquisar_Usuarios extends javax.swing.JFrame {

    /**
     * Creates new form Pesquisar_Usuarios
     */
    public Pesquisar_Usuarios() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pesquisar_Usuarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pesquisar_Usuarios().setVisible(true);
            }
        });
    }
